...
function MapBarChart({
  ...
  const data = useMemo(() => ({
    2015: [
      ...
      ['Republic of Korea', 34.356, 4.557, 1.016, 0.024, 61, -10],
    ...
    2016: [
      ...
      ['Republic of Korea', 35.0, 4.373, 0.94, 0.0, 61, -10],
    ...
    2017: [
      ...
      ['Republic of Korea', 38.117, 4.37, 0.807, 0.033, 61, -10],
    ...
    2018: [
      ...
      ['Republic of Korea', 34.418, 4.016, 0.719, 0.012, 61, -10],
    ...
    2019: [
      ...
      ['Republic of Korea', 25.21, 3.897, 0.655, 0.014, 61, -10],
    ...
    2020: [
      ...
      ['Republic of Korea', 32.878, 3.921, 0.722, 0.059, 61, -10],
    ...
    2021: [
      ...
      ['Republic of Korea', 31.462, 4.067, 0.737, 0.163, 61, -10],
    ...
    2022: [
      ...
      ['Republic of Korea', 32.391, 4.231, 0.711, 0.183, 61, -10],
    ...
    2023: [
      ...
      ['Republic of Korea', 29.245, 4.311, 0.831, 0.24, 61, -10],
